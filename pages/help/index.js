...
const HelpPage = () => {
    return (
        <AdminLayout>
            <div className='shadow-md p-10 m-8 rounded grid grid-cols-2 gap-2 font_family'>
                <div>
                    <h2 className='flex gap-2 items-center text-[34px]'><span ><FcOnlineSupport size={30} /></span> Get in touch</h2>
                    <p className='text-[18px] leading-loose'>Want to get in touch? We would love to hear form <br /> Here is how you can reach us...</p>
