    ...
    return (
        <AdminLayout>
            <div className='bg-gray-50 h-auto m-10 w-[90%] text-[16px]'>
                ...
                <p>On the TaxFile pricing page, you can add tax pricing depending on the user's role, Stripe, Paypal,Razorpay,Mollie, You can take your payment through these 4 channels
                </p>
