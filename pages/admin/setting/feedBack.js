    ...
    return (
        <AdminLayout>
            <div className='bg-gray-50 h-auto m-6 w-[90%] text-[16px] p-4'>
                ...
                <div className='m-4'>
                    <p>On this page, the admin can see all the responses of his users. This response will be taken from the user panel <a href="/user/feebbackUS/">User feedback</a> and can be seen in the table in the admin panel</p>
                    <img className='h-auto w-auto' src="/images/feedback.png" alt="" />
