        ...
        <AdminLayout>
            <div className='bg-gray-50 h-auto m-6 w-[90%] text-[16px] p-4'>
                ...
                <ul className='list-disc'>
                    ...
                    <li className='my-4'>
                        <p >Then you can see a modal, follow the picture.</p>
                    ...
                    <li className='my-4'>
                        <p >Then <span onClick={handleTextLink} className='font-bold text-red-600 cursor-pointer'>Click Here</span> , You get some information, like this picture. <span className='font-bold text-red-600'>Copy them.</span></p>
                        <img className='h-auto w-auto my-2' src="/images/m7.png" alt="" />
                    </li>
                    <li className='my-4'>
                        <p >Then <span className='font-bold text-red-600'>Paste them here. and hit Insert</span> </p>
