        ...
        <AdminLayout>
            <div className='bg-gray-50 h-auto m-6 w-[90%] text-[16px]'>
                <div className='my-4'>
                    ...
                    <img className='h-[500px]' src="/images/userForm.png" alt="" />
                </div>
                <div className='my-4'>
                    ...
                    <img className='h-[500px]' src="/images/viewFormfield.png" alt="" />
                </div>
                <div className='my-4'>
                    ...
                    <img className='h-[500px]' src="/images/addfeild.png" alt="" />
                </div>
            </div>
        </AdminLayout>
    );
