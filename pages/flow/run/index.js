    ...
    return (
        <AdminLayout>
            <div className='bg-gray-50 h-auto m-6 w-[90%] text-[16px] p-4'>
                <h5 className='text-center font-bold'>Website Run Time Work Flow</h5>
                <div className='m-4'>
                    <h5 className='border-b-[1px] border-black capitalize'>1. Setting Form Fill up</h5>
                ...
                <div className='m-4'>
                    ...
                    <p>It is very very important to restart your server. After completing the restart go to your website reload this page and you can see the frontend home page. Now you need to set up all the basic and necessary information.</p>
                ...
                <div className='m-4'>
                    ...
                    <p>To log in to your website, use the email you used when filling out the settings form.</p>
                ...
                <div className='m-4'>
                    ...
                    <p>Open your dashboard, scroll to the sidebar and find website settings, then click on it, you need to fill out the information here, but for initial set up you need to fill out <span className='text-red-500'> Website Information, Manage SMTP Setting, Environment Setting</span> at first .</p>
